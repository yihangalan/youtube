    ...
    return(
        <Container>
            <Content>
                ...
                <Title>Relax with my cat - beats to sleep/study x Fall In Luv</Title>
                <Details>
                    <Info>1.2M views • 1 year ago</Info>
                    <Buttons>
                        <Button>
                            <ThumbUpOutlinedIcon/>123k
